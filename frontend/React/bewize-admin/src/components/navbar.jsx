import { faEye, faMoon } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <a href="https://bewize.com" className="flex ms-2 md:me-24">
                <img
            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                <div className="flex flex-row items-center justify-start gap-4">
                  <FontAwesomeIcon className="text-2xl  text-gray-300 bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" icon={faMoon} />
                  <button
                    type="button"
